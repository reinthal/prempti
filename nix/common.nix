...
rec {
  ...
  mkSetupScript = cfg:
    let
      ...
      pluginConfig = pkgs.writeText "falco.coding_agents_plugin.yaml" ''
        # Generated by the Prempti Nix module. Edit via services.prempti.*
        plugins:
          - name: coding_agent
